...
public class DealsActivity extends AppCompatActivity implements View.OnClickListener, DealsAdapter.UpdateCartCountD,DealsAdapter.AdapterPosD {
    ...
    private void setupDeals() {
        DealsAdapter ca = new DealsAdapter( getDeals.getProductData(),mContext,"Deal",this,this);
    ...
    public void adapterPositionD(int pos) {
        Intent a = new Intent(mContext, DealsforYouProductDetails.class);
