...
import com.store.promtech.adapter.SubSubCategoryAdapter;
...
public class SubSubCategoryPage extends AppCompatActivity implements View.OnClickListener, SubCategoryAdapter.AdapterPos {
    ...
    public static SubSubCategoryDataResponse productModel;
    String category_id,subCategory_id, category_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subCategory_id = getIntent().getExtras().getString("sub_category_id");
    ...
    private void parsejson() {
        ...
        Call<SubSubCategoryDataResponse> call = redditAPI.GeSubSubCategoryDataResponse(subCategory_id);
        call.enqueue(new Callback<SubSubCategoryDataResponse>() {

            @Override
            public void onResponse(Call<SubSubCategoryDataResponse> call, retrofit2.Response<SubSubCategoryDataResponse> response) {
            ...
            @Override
            public void onFailure(Call<SubSubCategoryDataResponse> call, Throwable t) {
                pDialog.dismiss();
            }
        });
    }
    ...
    private void inflateAdapter() {
        SubSubCategoryAdapter ca = new SubSubCategoryAdapter(mContext, productModel.getSubCategoryData(), this::adapterPositionSub);
    ...
    public void adapterPositionSub(int pos) {
        ...
        a.putExtra("sub_category_id", subCategory_id);
        a.putExtra("subSub_category_id", productModel.getSubCategoryData().get(pos).getSubcategoryId());
