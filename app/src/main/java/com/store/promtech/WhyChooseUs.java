...
public class WhyChooseUs extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whychoose_us);
        mContext = this;
        ...
        String text="1. Wide variety range of products are available\n" +
                "2. Affordable prices\n" +
                "3. Gift vouchers and discounts\n" +
                "4. Get detailed information about the product\n" +
                "5. The convenience of shopping at home\n" +
                "6. Availability 24*7\n" +
                "7. Online tracking\n" +
                "8. Quick and easy product replacement and refund *\n" +
                "9. Customers can compare various models/brands\n" +
                "10. Free shipping *\n" +
                "*T&amp;C ";
