...
public class OrderCancellation extends AppCompatActivity implements View.OnClickListener {
...
//            tv_desc.setText(Html.fromHtml(aboutUs.getPrivacyData().getContent(),Html.FROM_HTML_MODE_LEGACY));
//        } else {
            //tv_desc.setText(Html.fromHtml(aboutUs.getPrivacyData().getContent()));
            tv_desc.setText(aboutUs.getPrivacyData().getContent());
//        }
    }
    ...
    private void parsejson() {
        ...
        Call<OrderCancellationModel> call = redditAPI.Getorder_cancellation();
