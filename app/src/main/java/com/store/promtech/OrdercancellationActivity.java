...
public class OrdercancellationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void setData() {
     ...
     //   Spanned htmlAsSpanned = Html.fromHtml(aboutUs.getAboutData().getContent());
    ...
    private void parsejson() {
        ...
        Call<Privacymodel> call = redditAPI.GetPrivacyData();
