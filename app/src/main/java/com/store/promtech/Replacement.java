...
public class Replacement extends AppCompatActivity implements View.OnClickListener {
    ...
    private void parsejson() {
        ...
        Call<OrderCancellationModel> call = redditAPI.Getorder_Replacement();
        call.enqueue(new Callback<OrderCancellationModel>() {
            ...
            public void onResponse(Call<OrderCancellationModel> call, retrofit2.Response<OrderCancellationModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if(aboutUs.getPrivacyData().getAck()==1) {
                        if (aboutUs != null) {
                            setData();
                        }
                    }
