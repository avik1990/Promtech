...
public class OfferDetailsDetails extends AppCompatActivity implements View.OnClickListener {
...
//        tv_title.setText(Dashboard.getOffer.getProductData().get(position).getProductNameEnglish());
////        tv_desc.setVisibility(View.VISIBLE);
////       tv_desc.setText(Dashboard.getOffer.getProductData().get(position).getProductDetails());
////        product_id = Dashboard.getOffer.getProductData().get(position).getProductId();
////
////        try {
////            Picasso.with(mContext)
////                    .load(Dashboard.getOffer.getProductData().get(position).getProductPhoto())
...
//        if (Dashboard.getOffer.getProductData().get(position).getPackets().size() > 0) {
...
//            for (int i = 0; i <Dashboard.getOffer.getProductData().get(position).getPackets().size(); i++) {
...
//                tv_cat.setText(Dashboard.getOffer.getProductData().get(position).getPackets().get(i).getPacketSize());
//
...
//
//                tv_offered_price.setText(Dashboard.getOffer.getProductData().get(position).getPackets().get(i).getPrice());
//                tv_discount_percent.setText(Dashboard.getOffer.getProductData().get(position).getPackets().get(i).getDiscount() + " off");
//                tv_orginal_price.setText(Dashboard.getOffer.getProductData().get(position).getPackets().get(i).getOriginalPrice());
...
//
//
//                if (i == Dashboard.getOffer.getProductData().get(position).getPackets().size() - 1) {
...
//                    if (Dashboard.getOffer.getProductData().get(position).getPackets().get(i).getPacketId().equalsIgnoreCase(st_packet_id)) {
...
//                    @Override
//                    public void onClick(View v) {
//                        st_packet_id = Dashboard.getOffer.getProductData().get(position).getPackets().get(tv_cat.getId()).getPacketId();
//                        inflateRadioGroup();
//                    }
//                });
