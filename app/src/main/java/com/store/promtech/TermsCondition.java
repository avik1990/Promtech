...
public class TermsCondition extends AppCompatActivity implements View.OnClickListener {
    ...
    private void parsejson() {
        ...
        Call<TermsConditionmodel> call = redditAPI.GetTermData();
        call.enqueue(new Callback<TermsConditionmodel>() {

            @Override
            public void onResponse(Call<TermsConditionmodel> call, retrofit2.Response<TermsConditionmodel> response) {
